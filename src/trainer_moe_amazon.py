...
mode=f"{num_experts}_{num_experts_per_tok}_cbz_u" #ce/cbz/cb/cz/15_3_cbz
dt="amazon"


args=ModelArgs(dim=768,hidden_dim=3072,num_labels=5,moe=MoeArgs(num_experts,num_experts_per_tok))
...
tokenized_dataset = tokenized_dataset.remove_columns(["text", "idx","label_text"])
