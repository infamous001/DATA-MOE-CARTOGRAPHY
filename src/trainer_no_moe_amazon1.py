...
mode="amazon_no_moe_f" #ce/cbz/cb/cz/no_moe
...
ds_train = load_dataset('csv', data_files='data/amazon/train.csv')
ds_val = load_dataset('csv', data_files='data/amazon/val.csv')
ds_test = load_dataset('csv', data_files='data/amazon/test.csv')
...
tokenized_dataset = tokenized_dataset.remove_columns(["text","label_text","id","idx"])
