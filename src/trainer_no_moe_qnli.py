...
def preprocess_function(examples):
    return tokenizer(examples["text1"],examples["text2"], truncation=True, max_length=128, padding=True)
...
mode="qnli_no_moe_f" #ce/cbz/cb/cz/no_moe
...
ds_train = load_dataset('csv', data_files='data/qnli/train.csv')
ds_val = load_dataset('csv', data_files='data/qnli/val.csv')
ds_test = load_dataset('csv', data_files='data/qnli/test.csv')
